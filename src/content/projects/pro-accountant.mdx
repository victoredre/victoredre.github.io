---
title: laboratorio de pruebas multicapa sobre infraestructura Linux, orientado a la simulación de ataques (hacking ético/pentesting) y validación de seguridad perimetral, previo a la implementación en ambiente productivo.  
