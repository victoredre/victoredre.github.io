...
summary: la selección de equipos se hace pensando en casos de uso específicos desde la alta disponibilidad y el rendimiento extremo en el core del centro de datos, hasta la seguridad unificada para sucursales y entornos pequeños. La clave está en entender el "por qué" detrás de cada modelo.
tags:
...
6. [Palo Alto Network](#Palo Alto Network)
7. [ESET](#ESET)
