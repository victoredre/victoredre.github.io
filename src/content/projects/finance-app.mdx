...
Desde configuraciones basicas como procesos de **Firmware** y/o alta en la **WAN** para **DHCP, Estatitca y PPPoE** hasta **SD-WAN**, **NAT**, **VPN IPsec, VPN SSL** **Políticas IPv4**, **Antivirus**, **Filtrado Web** **IPS** **App Control** **Ruteo estatico/dinámico**, **BGP en VPN Loopback**, **segmentación por VLAN's** VDOM, IPS y Web Filter, DNS y VPNE-GRE, así como casos de nivel N2 troubleshooting Va, todo en un solo párrafo, sin listas, listo para tu CV:
