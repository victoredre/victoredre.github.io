...
Desde configuraciones basicas como procesos de **Firmware** y/o alta en la **WAN** para **DHCP, Estatitca, PPPoE** hasta **SD-WAN**, **NAT**, **VPN IPsec, VPN SSL**, **Políticas IPv4**, **Antivirus**, **Filtrado Web**, **IPS**, **App Control**, **Ruteo estatico/dinámico**, **BGP en VPN Loopback**, **segmentación por VLAN's**, **VDOM**, **IPS** y **Web Filter**, **DNS** y **VPN-GRE**, así como casos de nivel N2 troubleshooting via CLI con análisis de flujo de tráfico para validar políticas debug flow, verificación de estado y negociación de túneles VPN IPsec, captura y análisis de paquetes en tiempo real, validación de vecindades y anuncio de rutas BGP, monitoreo de consumo de CPU y memoria para detección de procesos críticos sys top.
