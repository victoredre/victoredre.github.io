...
IKE Phase 1 no levanta
Síntoma: Túnel no establece, sin tráfico.
'''bash
# Ver estado
...
# Lo que buscas en el log
# "no proposal chosen" = missmatch en encryption/hash
# "invalid ID" = problema de peer ID
# "timeout" = problema de conectividad/firewall
