...
title: Instalacion de servicios Vcenter.
tags:
  - general
  - docs
description: "La instalación de vCenter Server se realiza desplegando el vCenter Server Appliance (VCSA), una VM preconfigurada. El proceso consta de dos etapas principales: desplegar la OVA y configurar el appliance."
cover:
