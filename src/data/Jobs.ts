...
const workExperience:WorkExperience[] = [
    {
        ...
        goals:  [
            ...
            "Gestione e optimice hasta un 40% el tiempo de implementaciones e integrar python para garantizar tanto la actualizacion e configuración de equipos bajo el ecosistema Fortinet desplegando unidades como: (FortiADC, FortiWifi, FortiManager, FortiSwitch, FortiAnalyzer, FortiNAC, FortiEMS).",
            "Aseguré el cumplimiento de los SLA's logrando un tiempo de contención menor a 15 minutos en alertas críticas en el tablero de Falcon.",
                ],
        currentJob: false, 
    }, 
    {
