...
const workExperience:WorkExperience[] = [
    ...
    },
    {
        ...
        goals: [
            "Administré accesos seguros y multifactor mediante RSA, controlé la postura de seguridad de endpoints con Trend Micro (Antivirus/EDR) y supervisé el cumplimiento de políticas de prevención de fuga de información a través de DLPe.",
